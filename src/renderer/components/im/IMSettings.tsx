              ...
              <div key="dingtalk">
                ...
                >
                  <div className="flex flex-1 items-center">
                    ...
                    <span className={`text-sm font-medium truncate ${activePlatform === 'dingtalk' ? 'text-claude-accent' : 'dark:text-claude-darkText text-claude-text'}`}>
                    ...
                    {config.dingtalk.instances.map((inst) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`truncate flex-1 ${isSelected ? 'text-claude-accent font-medium' : 'dark:text-claude-darkText text-claude-text'}`}>
                            {inst.instanceName}
                          </span>
                        </div>
                      );
              ...
              <div key="feishu">
                ...
                >
                  <div className="flex flex-1 items-center">
                    ...
                    <span className={`text-sm font-medium truncate ${activePlatform === 'feishu' ? 'text-claude-accent' : 'dark:text-claude-darkText text-claude-text'}`}>
              ...
              <div key="qq">
                ...
                >
                  <div className="flex flex-1 items-center">
                    ...
                    <span className={`text-sm font-medium truncate ${activePlatform === 'qq' ? 'text-claude-accent' : 'dark:text-claude-darkText text-claude-text'}`}>
                      {i18nService.t('qq')}
                    </span>
                  </div>
      ...
      <div className="flex-1 min-w-0 pl-4 pr-2 space-y-4 overflow-y-auto [scrollbar-gutter:stable]">
        ...
        {activePlatform === 'dingtalk' && !activeDingTalkInstanceId && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-claude-textSecondary dark:text-claude-darkTextSecondary mb-4">
            ...
            {config.dingtalk.instances.length < MAX_DINGTALK_INSTANCES && (
              <button
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium bg-claude-accent/10 text-claude-accent hover:bg-claude-accent/20 transition-colors"
              >
